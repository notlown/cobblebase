...
object SpeciesSkillRegistry {
    ...
    private fun registerDefaults() {
        // -- Water --
        mon("squirtle",     sk("cobblebase:fishing", 3), sk("cobblebase:water_fill", 2), sk("cobblebase:extinguisher", 2))
        mon("wartortle",    sk("cobblebase:fishing", 4), sk("cobblebase:water_fill", 3), sk("cobblebase:extinguisher", 3))
        mon("blastoise",    sk("cobblebase:fishing", 5), sk("cobblebase:water_fill", 4), sk("cobblebase:guard", 3))
        ...
        // -- Fire --
        mon("charmander",   sk("cobblebase:lava_fill", 2), sk("cobblebase:furnace_fuel", 2))
        mon("charmeleon",   sk("cobblebase:lava_fill", 3), sk("cobblebase:furnace_fuel", 3))
        mon("charizard",    sk("cobblebase:lava_fill", 4), sk("cobblebase:furnace_fuel", 4), sk("cobblebase:guard", 3), sk("cobblebase:scout", 4))
        ...
        // -- Grass --
        mon("bulbasaur",    sk("cobblebase:harvester", 2), sk("cobblebase:irrigator", 1))
        mon("ivysaur",      sk("cobblebase:harvester", 3), sk("cobblebase:irrigator", 2))
        mon("venusaur",     sk("cobblebase:harvester", 5), sk("cobblebase:irrigator", 4))
        ...
        // -- Normal --
        mon("ditto",        sk("cobblebase:gatherer", 3), sk("cobblebase:pickup", 3))
        mon("eevee",        sk("cobblebase:gatherer", 2), sk("cobblebase:pickup", 2))
        mon("snorlax",      sk("cobblebase:guard", 4))
        mon("chansey",      sk("cobblebase:healer", 5))
        mon("blissey",      sk("cobblebase:healer", 5), sk("cobblebase:pickup", 3))
        mon("meowth",       sk("cobblebase:pickup", 4), sk("cobblebase:gatherer", 2))
        mon("persian",      sk("cobblebase:pickup", 5), sk("cobblebase:gatherer", 3))
