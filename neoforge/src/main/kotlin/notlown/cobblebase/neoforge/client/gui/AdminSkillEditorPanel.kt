...
class AdminSkillEditorPanel(
    ...
    private fun saveChanges() {
        ...
        PacketDistributor.sendToServer(AdminSpeciesUpdateC2SPacket(species, assignedSkills, false))
    ...
    private fun resetToDefault() {
        val species = selectedSpecies ?: return
        PacketDistributor.sendToServer(AdminSpeciesUpdateC2SPacket(species, emptyList(), true))

        // Re-request data from server
