...
class AdminSkillEditorPanel(
    ...
    private fun saveChanges() {
        ...
        PacketDistributor.sendToServer(AdminSpeciesUpdateC2SPacket(
    ...
    private fun resetToDefault() {
        val species = selectedSpecies ?: return
        PacketDistributor.sendToServer(AdminSpeciesUpdateC2SPacket(species, emptyList(), true, null, 0, 0L, true))
        PacketDistributor.sendToServer(notlown.cobblebase.core.net.AdminSpeciesRequestC2SPacket())
        dirty = false
    }
