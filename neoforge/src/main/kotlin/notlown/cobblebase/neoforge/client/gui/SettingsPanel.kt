...
class SettingsPanel(
    ...
    fun init(addWidget: Function<ButtonWidget, ButtonWidget>) {
        ...
        PacketDistributor.sendToServer(PastureSettingsRequestC2SPacket())
    ...
    fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        context.drawCenteredTextWithShadow(textRenderer, "-", minusBtnX + minusBtnW / 2, minusBtnY + 6, minusColor)

        // Current value display
        context.drawCenteredTextWithShadow(textRenderer, "$currentRadius", controlCenterX, controlY + 6, 0x55FF55)
        ...
        context.drawCenteredTextWithShadow(textRenderer, "+", plusBtnX + plusBtnW / 2, plusBtnY + 6, plusColor)
    ...
    private fun sendUpdate() {
        PacketDistributor.sendToServer(PastureSettingsUpdateC2SPacket(currentRadius))
    }
